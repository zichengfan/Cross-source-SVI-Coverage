...
NAVER_MIXED_PANORAMA_OVERLAY_TYPE = "pr"
NAVER_STREET_ONLY_OVERLAY_TYPE = "ps"
...
class NaverPanoramaFrontendConfig:
    ...
    street_only_overlay_template: str
...
def discover_naver_panorama_frontend_config(
    *,
    ...
    street_only_overlay_template = base_style_template + f"?mt={NAVER_STREET_ONLY_OVERLAY_TYPE}"
    ...
    return NaverPanoramaFrontendConfig(
        ...
        street_only_overlay_template=street_only_overlay_template,
...
def build_naver_street_only_overlay_url(version: str, z: int, x: int, y: int) -> str:
    return f"https://map.pstatic.net/nrb/styles/basic/{version}/{z}/{x}/{y}.png?mt={NAVER_STREET_ONLY_OVERLAY_TYPE}"
